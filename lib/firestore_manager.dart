...
class CollectionManager {
  ...
  Future<void> addNewDocument({String? documentId, required Map<String, dynamic> documentMap}) async {
    try {
      ...
      if(documentId!=null){
        ...
        print('✅ Document added successfully with manual ID: $documentId');
      }else{
        docRef = await db.collection(collectionName).add(documentMap);
        print('✅ Document added successfully with autoGenerated ID: ${docRef.id}');
      }
    } catch (e) {
  ...
  Future<List<Map<String,dynamic>>> readCollection() async {
    ...
    try {
      ...
      print('❌ Failed to read collection: $e');
      return [];
    }
  }
  ...
  Future<void> deleteDocument({
    ...
    try {
      ...
      print('🗑️ Document $documentId deleted successfully.');
    } catch (e) {
